#' analysis_covariate
#'
#' Fit a covariate configural model (Y ~ X + M) to the data using linear regression and a Maximum Likelihood estimator. Extract the beta estimates, their 95% CIs and p values.
#'
#' @import stats
#' @import utils
#' @import graphics
...
#' 
#' @export
analysis_covariate <- function(data){
